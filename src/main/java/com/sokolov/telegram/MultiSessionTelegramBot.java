...
public class MultiSessionTelegramBot extends TelegramLongPollingBot {
    ...
    /**
     * Method returns the ID of the current Telegram chat
     */
    ...
    /**
     * Method returns the text from the last Telegram chat message
     */
    ...
    /**
     * Method returns the pressed button code (buttonKey).
    ...
    /**
     * Method sends TEXT (text message) to the chat.
    ...
    /**
     * Method sends HTML (text message) to the chat.
    ...
    /**
     * Method sends a PHOTO (Image) to the chat.
     * Image is specified by photoKey.
     * All images are stored in the resources/images folder
     */
    ...
    /**
     * Method sends both PHOTO (Image) and TEXT to the chat.
     * Image is specified by photoKey.
     * All images are stored in the resources/images folder
     */
    ...
    /**
     * Method changes the TEXT in an already sent message.
     */
